...
<div id="main">
	<div class="col-md-12">
		<h3 class="page-title">Danh sách thông báo - chính sách</h3>
	</div>
	<!-- Search -->
	<div class="col-md-12">
	...
	<table class="table table-striped table-hover">
		<thead>
			<tr>
				...
				<th scope="col">Tiêu đề<i class="fa fa-sort icon-float-right"></i></th>
				<th scope="col">Nội dung<i class="fa fa-sort icon-float-right"></i></th>
				<th scope="col">Người gửi<i class="fa fa-sort icon-float-right"></i></th>
